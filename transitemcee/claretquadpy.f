      subroutine claretquad(filename,teff,logg,feh,ld1,ld2)
Cf2py intent(out) :: ld1, ld2
      implicit none
     ...
     .  pars(4),cmin(2),c1(4),c2(4),c3(4),c4(4),c5(4),c6(4),c7(4),c8(4)
      real teffmin,teffmax,loggmin,loggmax,fehmin,fehmax,ld1,ld2
...
c      goto 999
c 902  write(0,*) "Usage: claret-limb-quad.txt Teff log(g) [Fe/H]"
